...
async function submitKudos(formData) {
    ...
    if (!currentUser) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])("/login?from=/feed");
    }
...
/* __next_internal_action_entry_do_not_use__ [{"406c201baa2354bf0c6949508421d0f5db11ce1a5f":"login","407cd4f7601f3c3e8a3c3403e9a5463ff3d71d1dbc":"signup"},"",""] */ __turbopack_context__.s([
    "login",
    ()=>login,
    "signup",
    ()=>signup
...
async function signup(formData) {
    ...
    const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].teamMember.findUnique({
        where: {
            email
        }
    });
    ...
    const member = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].teamMember.create({
        data: {
            name: fullName,
...
async function login(formData) {
    ...
    if (members.length > 1 && !email) {
        return {
            success: false,
            error: "Multiple accounts with this name. Please enter your email to log in.",
            fieldErrors: {
                email: "Email required to disambiguate."
            }
        };
    }
    ...
    const valid = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$password$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["verifyPassword"])(password, candidate.passwordHash);
    if (!valid) {
        return {
            success: false,
            error: "Invalid name or password."
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$session$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["setSession"])(candidate.id);
    return {
        success: true,
        redirectTo
    };
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(signup, "407cd4f7601f3c3e8a3c3403e9a5463ff3d71d1dbc", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(login, "406c201baa2354bf0c6949508421d0f5db11ce1a5f", null);
}),
"[project]/.next-internal/server/app/signup/page/actions.js { ACTIONS_MODULE0 => \"[project]/app/actions/session.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/app/actions/kudos.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/app/actions/auth.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "407cd4f7601f3c3e8a3c3403e9a5463ff3d71d1dbc",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__902cf39e._.js.map